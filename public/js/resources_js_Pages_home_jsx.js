...
/* harmony import */ var lunr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lunr */ "./node_modules/lunr/lunr.js");
/* harmony import */ var lunr__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lunr__WEBPACK_IMPORTED_MODULE_4__);
...
function spaceFilter(token) {
  return Object.entries(token).map(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        key = _ref2[0],
        value = _ref2[1];

    return _defineProperty({}, key, typeof value === 'undefined' ? value.split(' ') : value);
  });
}
...
var Home = function Home() {
  ...
  for (i = 0; i < posts.length; i++) {
    ...
    documents[i] = [(_ref4 = {
      ...
      slug: posts[i].slug
    }, _defineProperty(_ref4, 'content', posts[i].content), _defineProperty(_ref4, 'content_ES', posts[i].content_ES), _ref4)];
    console.log(_typeof(documents[i]));
    documents[i] = spaceFilter(documents[i]);
  }
